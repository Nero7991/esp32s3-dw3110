...
/** Acquire SPI bus for exclusive use. While held, individual SPI read/write
 * calls skip per-transaction bus acquisition, reducing overhead. */
void dw3000_spi_acquire(void);
void dw3000_spi_release(void);
